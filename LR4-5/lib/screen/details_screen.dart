import 'package:lr4_5/model/animal_model.dart';
      ...
      body: Container(
        ...
        child: Stack(
          children: [
            ...
            Positioned(
              right: -mediaQuery.size.width * .24,
              child: Container(
                margin: EdgeInsets.fromLTRB(
                    5,
                    mediaQuery.padding.top + mediaQuery.size.height * .4,
                    5,
          ...
          ElevatedButton(
            ...
            style: ElevatedButton.styleFrom(
              ...
              padding: EdgeInsets.symmetric(
                horizontal: mediaQuery.size.width * .01,
                vertical: mediaQuery.size.height * .01,
              ),
              backgroundColor: const Color(0xEAAA5252),
              foregroundColor: Colors.white,
            ),
            child: const Text("No action 1"),
          ),
          //круг с углом
          const Spacer(),
          ElevatedButton(
